...
var game = {
	...
	"loaded" : function () {
		...
		me.entityPool.add("GameEntity", game.GameEntity);
	...
	mouseIsOver : function (objectA) {
		if(me.input.mouse.pos.x >= objectA.pos.x &&
		   me.input.mouse.pos.x <= objectA.pos.x + objectA.collisionBox.width &&
		   me.input.mouse.pos.y >= objectA.pos.y &&
		   me.input.mouse.pos.y <= objectA.pos.y + objectA.collisionBox.height) return true;
		return false;
	}
};