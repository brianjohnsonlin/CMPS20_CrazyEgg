 ...
 * 			so on for custom. Not set is self-click.
...
game.EntityState = {
	//collision types
	type: null, //default type null
	changingType: null,
	//collision box
	collision: [-1,-1,-1,-1], //default no change
	//animation frames
	frames: null, //required 
	changingFrames: null, //default skip changing frames
	//ID of next state
	nextState: null, //default is not clickable
	//sound when changing to different state
	sfx: null //default no sound
	//amount of seconds it takes for it to change out of this state
	timer: 0 //default does not revert
	//can I click this state?
